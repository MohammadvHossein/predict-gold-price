...
paxgusdt_15min_df = pd.concat([df_2022, df_2023, df_2024], ignore_index=True)

# Save the concatenated DataFrame to a CSV file
paxgusdt_15min_df.to_csv('paxgusdt_15min.csv', index=False)
print(len(paxgusdt_15min_df))